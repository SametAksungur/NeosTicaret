...
# bu sayfada yapılan her degısıklıkten sonra makemigrations ve miggrate
# komutlarının girilmesı gerekıyor.
...
class Urun(models.Model):
    ...
    # __str__: admın panelinde göstermek istedıgımız bilgi
