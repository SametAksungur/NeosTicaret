...
--------,
Veri atbanından resım eklemek 146.satır
ancak ılk olarak import os komutunun girilmesi
...
SECRET_KEY = 'django-insecure-06(=eu!=mh3p%^p*f^y7_lp6=&_wuq=&#qpv(_e=bx7*ac*=mr'
...
# error mesaj tag ını danger e cevirme renk değistirme
MESSAGE_TAGS = {
